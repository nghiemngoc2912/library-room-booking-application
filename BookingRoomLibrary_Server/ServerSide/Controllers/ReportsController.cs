...
public class ReportsController : ControllerBase
{
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateReport(int id, [FromBody] ReportUpdateDTO reportDto)
    {
        try
        {
            await _reportService.UpdateReportStatusAsync(id, reportDto.Status);
            return NoContent();
        }
        catch (KeyNotFoundException)
        {
